                        ...
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    ...
                                    <p class="mb-0 dark:text-white dark:opacity-60">
                                        <span class="text-sm font-bold leading-normal text-emerald-500">Categorias</span>
                                    </p>
                                </div>
                            </div>
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor" class="bi bi-tag-fill text-lg relative top-3.5 text-white" viewBox="0 0 16 16">
                                        <path
                        ...
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-award-fill text-lg relative top-3.5 text-white" viewBox="0 0 16 16">
                        ...
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-piggy-bank-fill text-lg relative top-3.5 text-white" viewBox="0 0 16 16">
                        ...
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-earmark-bar-graph-fill text-lg relative top-3.5 text-white" viewBox="0 0 16 16">
                        ...
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-credit-card-2-back-fill text-lg relative top-3.5 text-white" viewBox="0 0 16 16">
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="flex justify-center w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-blue-500 to-violet-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-people-fill text-lg relative top-3.5 text-white" viewBox="0 0 16 16">
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="flex justify-center w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-red-600 to-orange-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-fill text-lg relative top-3.5 text-white" viewBox="0 0 16 16">
